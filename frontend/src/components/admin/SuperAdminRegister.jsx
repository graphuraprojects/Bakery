  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-pink-50 to-orange-100 px-4">
      <div className="mt-5 mb-5 w-full max-w-md">
        {/* Header Card */}
        <div className="bg-[#c85a32] text-white p-6 rounded-t-2xl shadow-lg text-center">
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#dfa26d] outline-none transition pl-10"
              />
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="flex items-center text-sm font-medium text-gray-600 hover:text-[#c85a32] transition-colors"
            >
          ...
          <div className="mt-6 p-4 bg-orange-50 border border-orange-100 rounded-lg">
            ...
            <ul className="text-xs text-orange-700 space-y-1">
              <li className="flex items-start">
                <i className="bx bx-check text-orange-600 mr-1 mt-0.5"></i>
