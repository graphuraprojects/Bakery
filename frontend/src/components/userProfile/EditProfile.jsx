...
export default function EditProfile() {
  ...
  return (
    <div className="pt-20 bg-[#f8f7f6] min-h-screen px-4 py-10">
      <div className="max-w-4xl mx-auto">
        {/* Back Button */}
        <button
          onClick={() => navigate("/profile")}
          className="mb-6 flex items-center text-[#dfa26d] hover:text-[#c98f5f] transition"
        >
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#dfa26d] focus:border-transparent outline-none transition"
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10 pt-6 border-t">
            <button
              onClick={() => navigate("/profile")}
              disabled={saving}
              className="px-8 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition font-semibold disabled:opacity-50"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className="flex-1 px-8 py-3 bg-[#DFA26D] text-white rounded-lg hover:bg-[#c98f5f] transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {saving ? (
                <>
